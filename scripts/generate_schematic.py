...
def build_legacy_schematic() -> str:
    components = [
        ...
        Component("TVS", "D1", "SMF3.3CA", "Diode_SMD:D_SOD-123F", 2700, 1500),
        Component(
            "R",
            "R1",
            "6.49R 0.1%",
            ...
            1850,
            {
                ...
                "Description": "CT split burden resistor, 25 ppm/K",
            },
        ),
        Component(
            "R",
        ...
        Component("R", "R3", "1k 0.1%", "Resistor_SMD:R_0603_1608Metric", 4200, 1750),
        Component("R", "R4", "1k 0.1%", "Resistor_SMD:R_0603_1608Metric", 4200, 2250),
        Component(
            "C",
            "C1",
            "10nF C0G",
        ...
        Component("TVS", "D2", "SMBJ18CA", "Diode_SMD:D_SMB", 2650, 3800),
        Component(
            "R",
            "R5",
            "100k 0.1%",
        ...
        Component("R", "R9", "1k 0.1%", "Resistor_SMD:R_0603_1608Metric", 5200, 4050),
        Component("R", "R10", "1k 0.1%", "Resistor_SMD:R_0603_1608Metric", 5200, 4550),
        Component(
            "C",
            "C2",
            "10nF C0G",
        ...
        Component("C", "C3", "1uF", "Capacitor_SMD:C_0603_1608Metric", 6500, 900),
        Component("C", "C4", "100nF", "Capacitor_SMD:C_0603_1608Metric", 6500, 1200),
        Component("C", "C5", "1uF", "Capacitor_SMD:C_0603_1608Metric", 8500, 900),
        Component("C", "C6", "100nF", "Capacitor_SMD:C_0603_1608Metric", 8500, 1200),
        Component("C", "C7", "220nF", "Capacitor_SMD:C_0603_1608Metric", 7800, 1700),
        Component("R", "R11", "10k", "Resistor_SMD:R_0603_1608Metric", 8600, 4400),
        Component("R", "R12", "10k", "Resistor_SMD:R_0603_1608Metric", 8600, 4700),
        Component("R", "R13", "33R", "Resistor_SMD:R_0603_1608Metric", 8600, 5000),
        Component(
            "PMOD",
            "J1",
            "Tiny Tapeout PMOD",
